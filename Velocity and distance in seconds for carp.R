...
ggplot(carp1, aes(xs, ys)) + geom_point() + geom_quantile(quantiles = .99, method = "rqss", lambda = 10)+
  geom_vline(xintercept = 86389, color = "red") +
  geom_vline(xintercept = 107989, color = "red") +
  geom_vline(xintercept = 172775, color = "red") +
  geom_vline(xintercept  = 194386, color = "red") +
  xlab("Time(seconds)") +
  ylab("Velocity") +
  ggtitle("Velocity Variability by Periods Through Time(Fish1)")

carp1filt <- carp1 %>% filter(ys > .90)
ggplot(carp1filt, aes(xs, ys)) + geom_point() + geom_quantile(quantiles = .90, method = "rqss", lambda = 10)+
  geom_vline(xintercept = 86389, color = "red") +
  geom_vline(xintercept = 107989, color = "red") +
  geom_vline(xintercept = 172775, color = "red") +
  geom_vline(xintercept  = 194386, color = "red") +
...
ggplot(carp2.2, aes(xs, ys)) + geom_point() + geom_quantile(quantiles = .99, method = "rqss", lambda = 10) +
  geom_vline(xintercept = 86384, color = "red") +
  geom_vline(xintercept = 107970, color = "red") +
  geom_vline(xintercept = 172783, color = "red") +
  geom_vline(xintercept  = 194384, color = "red") + 
  xlab("Time(seconds)") +
  ylab("Velocity") +
  ggtitle("Velocity Variability by Periods Through Time (Fish2)")

carp2filt <- carp2.2 %>% filter(ys > .90)
ggplot(carp2filt, aes(xs, ys)) + geom_point() + geom_quantile(quantiles = .90, method = "rqss", lambda = 10) +
  geom_vline(xintercept = 86384, color = "red") +
  geom_vline(xintercept = 107970, color = "red") +
  geom_vline(xintercept = 172783, color = "red") +
  geom_vline(xintercept  = 194384, color = "red") + 
...
ggplot(carp3.3, aes(xs, ys)) + geom_point()  + geom_quantile(quantiles = .99, method ="rqss", lambda = 10) +
  geom_vline(xintercept = 86346, color = "red") +
  geom_vline(xintercept = 107945, color = "red") +
  geom_vline(xintercept = 172739, color = "red") +
  geom_vline(xintercept  = 194351, color = "red") + 
  xlab("Time(seconds)") +
  ylab("Velocity") +
  ggtitle("Velocity Variability by Periods Through Time(Fish3)")

carp3filt <- carp3.3 %>% filter(ys > .90)
ggplot(carp3filt, aes(xs, ys)) + geom_point()  + geom_quantile(quantiles = .90, method ="rqss", lambda = 10) +
  geom_vline(xintercept = 86346, color = "red") +
  geom_vline(xintercept = 107945, color = "red") +
  geom_vline(xintercept = 172739, color = "red") +
  geom_vline(xintercept  = 194351, color = "red") + 
...
ggplot(carp4.4, aes(xs, ys)) + geom_point() + geom_quantile(quantiles = .99, method = "rqss", lambda = 10) +
  geom_vline(xintercept = 86378, color = "red") +
  geom_vline(xintercept = 107976, color = "red") +
  geom_vline(xintercept = 172765, color = "red") +
  geom_vline(xintercept  = 194377, color = "red") +
  xlab("Time(seconds)") +
  ylab("Velocity") +
  ggtitle("Velocity Variability by Periods Through Time(Fish4)")

carp4filt <- carp4.4 %>% filter(ys > .90)
ggplot(carp4filt, aes(xs, ys)) + geom_point() + geom_quantile(quantiles = .90, method = "rqss", lambda = 10) +
  geom_vline(xintercept = 86378, color = "red") +
  geom_vline(xintercept = 107976, color = "red") +
  geom_vline(xintercept = 172765, color = "red") +
  geom_vline(xintercept  = 194377, color = "red") +
...
ggplot(carp5.5, aes(xs, ys)) + geom_point() + stat_quantile(quantles = .99, method = "rqss", lambda = 10) +
  geom_vline(xintercept = 86387, color = "red") +
  geom_vline(xintercept = 107988, color = "red") +
  geom_vline(xintercept = 172786, color = "red") +
  geom_vline(xintercept  = 194388, color = "red") + 
  xlab("Time(seconds)") +
  ylab("Velocity") +
  ggtitle("Velocity Variability by Periods Through Time(Fish5)")

carp5filt <- carp5.5 %>% filter(ys >.90)
ggplot(carp5filt, aes(xs, ys)) + geom_point() + stat_quantile(quantles = .90, method = "rqss", lambda = 10) +
  geom_vline(xintercept = 86387, color = "red") +
  geom_vline(xintercept = 107988, color = "red") +
  geom_vline(xintercept = 172786, color = "red") +
  geom_vline(xintercept  = 194388, color = "red") + 
...
ggplot(carp6.6, aes(xs, ys)) + geom_point() + geom_quantile(quantiles = .90, method = "rqss", lambda = 10)  +
  geom_vline(xintercept = 86380, color = "red") +
  geom_vline(xintercept = 107959, color = "red") +
  geom_vline(xintercept = 172782, color = "red") +
  geom_vline(xintercept  = 194377, color = "red") + 
  xlab("Time(seconds)") +
  ylab("Velocity") +
  ggtitle("Velocity Variability by Periods Through Time(Fish6)")

carp6filt <- carp6.6 %>% filter(ys >.90)
ggplot(carp6filt, aes(xs, ys)) + geom_point() + geom_quantile(quantiles = .90, method = "rqss", lambda = 10)  +
  geom_vline(xintercept = 86380, color = "red") +
  geom_vline(xintercept = 107959, color = "red") +
  geom_vline(xintercept = 172782, color = "red") +
  geom_vline(xintercept  = 194377, color = "red") + 
...
ggplot(carp7.7, aes(xs, ys)) + geom_point() + geom_quantile(quantiles = .99, method = "rqss", lambda = 10)  +
  geom_vline(xintercept = 86383, color = "red") +
  geom_vline(xintercept = 107984, color = "red") +
  geom_vline(xintercept = 172771, color = "red") +
  geom_vline(xintercept  = 194386, color = "red") + 
  xlab("Time(seconds)") +
  ylab("Velocity") +
  ggtitle("Velocity Variability by Periods Through Time(Fish7)")

carp7filt <- carp7.7 %>% filter(ys > .90)
ggplot(carp7filt, aes(xs, ys)) + geom_point() + geom_quantile(quantiles = .90, method = "rqss", lambda = 10)  +
  geom_vline(xintercept = 86383, color = "red") +
  geom_vline(xintercept = 107984, color = "red") +
  geom_vline(xintercept = 172771, color = "red") +
  geom_vline(xintercept  = 194386, color = "red") + 
...
ggplot(carp8.8, aes(xs, ys)) + geom_point() + geom_quantile(quantiles =.99, method = "rqss", lambda = 10)  +
  geom_vline(xintercept = 86444, color = "red") +
  geom_vline(xintercept = 108020, color = "red") +
  geom_vline(xintercept = 172828, color = "red") +
  geom_vline(xintercept  = 194448, color = "red")  +
  xlab("Time(seconds)") +
  ylab("Velocity") +
  ggtitle("Velocity Variability by Periods Through Time(Fish8)")

carp8filt <- carp8.8 %>% filter(ys > .90)
ggplot(carp8filt, aes(xs, ys)) + geom_point() + geom_quantile(quantiles =.90, method = "rqss", lambda = 10)  +
  geom_vline(xintercept = 86444, color = "red") +
  geom_vline(xintercept = 108020, color = "red") +
  geom_vline(xintercept = 172828, color = "red") +
  geom_vline(xintercept  = 194448, color = "red")  +
...
ggplot(carp9.9, aes(xs, ys)) + geom_point() + geom_quantile(quantiles = .99, method = "rqss", lambda =10)  +
  geom_vline(xintercept = 86383, color = "red") +
  geom_vline(xintercept = 107978, color = "red") +
  geom_vline(xintercept = 172779, color = "red") +
  geom_vline(xintercept  = 194374, color = "red") +
  xlab("Time(seconds)") +
  ylab("Velocity") +
  ggtitle("Velocity Variability by Periods Through Time(Fish9)")

carp9filt <- carp9.9 %>% filter(ys >.90)
ggplot(carp9filt, aes(xs, ys)) + geom_point() + geom_quantile(quantiles = .90, method = "rqss", lambda =10)  +
  geom_vline(xintercept = 86383, color = "red") +
  geom_vline(xintercept = 107978, color = "red") +
  geom_vline(xintercept = 172779, color = "red") +
  geom_vline(xintercept  = 194374, color = "red") +
...
ggplot(carp10.0, aes(xs, ys)) + geom_point() + geom_quantile(quantiles = .90, method = "rqss", lambda = 10)  +
  geom_vline(xintercept = 86381, color = "red") +
  geom_vline(xintercept = 107982, color = "red") +
  geom_vline(xintercept = 172778,color = "red") +
  geom_vline(xintercept  = 194386,color = "red") +
  xlab("Time(seconds)") +
  ylab("Velocity") +
  ggtitle("Velocity Variability by Periods Through Time(Fish10)")


carp10filt <- carp10.0 %>% filter(ys > .90)
ggplot(carp10filt, aes(xs, ys)) + geom_point() + geom_quantile(quantiles = .90, method = "rqss", lambda = 10)  +
  geom_vline(xintercept = 86381, color = "red") +
  geom_vline(xintercept = 107982, color = "red") +
  geom_vline(xintercept = 172778,color = "red") +
  geom_vline(xintercept  = 194386,color = "red") +
